...
import static com.stanlong.constant.Constant.*;
...
public class JdbcUtil {
	 ...
	 * @return 查询到的多行结果
	 */
	public static <T> List<T> queryList(Connection conn,  String querySql, Class<T> tClass, boolean... isUnderlineToCamel)
	  throws Exception {
